...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXl1bWk5MTkiLCJhIjoiY2tqNXNoanFiNDduNDJ4c2NpNXBtYTYwMyJ9.3Dfn9k5wQbzklaKPgSlQyg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("/api/v1/bookings/checkout-session/".concat(tourId));
...
var bookBtn = document.querySelector("#book-tour"); // const userPhoto = document.que
// delegation
